...
echo "  1. Command Line Tools (git等)"
echo "  2. Homebrew"
echo "  3. GitHub CLI"
echo "  4. iTerm2"
echo "  5. Claude Code"
echo ""
echo "その後、リポジトリをクローンしてClaude Codeでセットアップを自動化します。"
echo ""
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "次のステップでリポジトリをクローンし、セットアップを自動化します。"
echo ""
echo "【次のステップ】"
echo ""
echo "1. iTerm2を起動（推奨、より快適な環境）："
echo "   - Spotlight（⌘+Space）で「iTerm」と入力"
echo "   - または、標準Terminalでも続行可能"
echo ""
echo "2. dotfilesリポジトリをクローン："
echo "   cd ~"
echo "   gh repo clone x24ken/dotfiles"
echo "   cd dotfiles"
echo ""
